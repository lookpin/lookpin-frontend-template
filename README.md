...
| 명칭     | 역할                                                    | 원칙                                                                                        |
| -------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| common   | 공통기능 모음                                           | 프로젝트 내 그 어떤 모듈도 import 불가 스토어 및 자체 업무 구성 불가                        |
| core     | 네트워크, 엔티티 및 레포지토리 선언                     | 오직 common 모듈만 import 가능 역할 외 다른 기능 제공 불가                                  |
| shared   | 다른 기능 모듈에서 공유되는 하위 기능 구현 및 공유      | common 과 core 모듈 요소만 import 가능 페이지 및 라우트 구성 불가                           |
...
본 템플릿을 올바르게 사용하기 위해선 **Node 16 버전이 필요**하며 LTS 버전 사용을 권장합니다.
